...
class Environment:
    ...
    def create_appart_polygon(self):
        ...
        """
        points = [
            (0, 0), (15, 0), (15, 4), (12, 8), (9, 8), (9, 6), (4, 6),
            (4, 8), (0, 8)
        ]
    ...
    def init_materials(self):
        ...
        self.materials['cloison'] = Material('cloison', 2.7, 0.05346, 'red')
        self.materials['glass'] = Material('glass', 6.3919, 0.00107, 'lightblue')
    ...
    def init_obstacles(self):
        ...
        #porte metalique
        self.obstacles.append(Obstacle(Position(5.8, 7.85), Position(5.8, 6.15), self.materials['metal'], 0.05))

    def init_emitters(self):
        """
        Initialise les émetteurs dans l'environnement.
        """
        self.emitters.append(Emitter(Position(9.4, 7), 20, 60e9))
        self.emitters.append(Emitter(Position(7, 4.5), 20, 60e9)) # emitteur optimal avec et sans ascenseur
        self.emitters.append(Emitter(Position(4.5, 5), 20, 60e9)) # emitteur optimale pour 2 emetteur avec et sans ascenseur
        self.emitters.append(Emitter(Position(10.5, 5), 20, 60e9)) # emitteur optimale pour 2 emetteur avec et sans ascenseur
    ...
    def init_receivers(self):
        ...
        """
        #self.receivers.append(Receiver(Position(47, 65), -90))
